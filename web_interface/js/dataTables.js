...
(function(h) {
    ...
    function sb(a) {
        var b = a.sPaginationType,
            ...
            b = h("<ul/>", {style: "margin-right : 5%"}).addClass(a.oClasses.sPaging + b)[0],
            f = a.aanFeatures;
        d || c.fnInit(a, b, e);
    ...
    h.extend(m.ext.classes, {
        ...
        sPaging: "pagination justify-content-end pagination-sm paging_",
                        ...
                        for (s = d.length; k < s; k++) {
                            ...
                            if (h.isArray(r)) {
                                ...
                                if (n !== null) {
                                    ...
                                    u = h("<a/>", {
                                        "class": "page-link"}).html(n).appendTo(temp_var)
                                    Va(u, {
                                        action: r
                                    }, v);
                                    m++
