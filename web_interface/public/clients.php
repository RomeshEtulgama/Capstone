<div class="starter-template">
    ...
    <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi dolorem repellendus cumque nemo, animi eligendi quas quos asperiores architecto ipsum natus ab placeat, praesentium iusto. Eum blanditiis quam voluptate molestiae.</p>
</div>
...
<div class="card bg-dark mb-3">
    ...
    <!-- Table -->
    <table class="table table-hover table-dark table-responsive-sm table-small-text" id="active_clients_table" style="width: 100%;">
