<div class="starter-template">
    ...
    <p class="lead">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error perspiciatis mollitia at eaque voluptatibus, eveniet deserunt quisquam ipsam veniam culpa quaerat labore distinctio, nostrum minima totam earum voluptatum porro sed.</p>
</div>
...
<div class="card bg-dark mb-3">
    ...
    <!-- Products Table -->
    <table class="table table-hover table-dark table-responsive-sm table-small-text" id="products_table" style="width: 100%">
        <?php //view_products(); 
        ?>
    </table>
    <script>
